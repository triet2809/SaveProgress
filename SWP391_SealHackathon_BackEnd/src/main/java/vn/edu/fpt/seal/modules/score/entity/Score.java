...
@Entity
@Table(name = "scores", uniqueConstraints = @UniqueConstraint(name = "uq_scores_submission_judge_criterion", columnNames = {"submission_id", "judge_id", "criterion_id"}))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class Score {
    ...
    @Column(name = "criterion_average_score", precision = 10, scale = 2)
    private BigDecimal criterionAverageScore;
    @Column(name = "criterion_variance", precision = 10, scale = 4)
    private BigDecimal criterionVariance;
    @Column(name = "criterion_stddev", precision = 10, scale = 4)
